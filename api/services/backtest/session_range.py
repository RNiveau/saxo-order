...
class SessionRangeStrategy:
    """The "bougie de 9h" family: a 9:00-10:00 H1 reference range fixes
    the levels, 5-minute candles are scanned after 10:00 for a
    breakout/reversal entry, and the day ends flat.

    Every backtest shipped before spec 026 runs on this strategy. It is
    evaluated one day at a time, which is what a reference range and an
    end-of-day exit make possible.
    """
    ...
    def __init__(
        ...
        self.logger = Logger.get_logger("backtest_session_range")
