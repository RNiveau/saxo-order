...
- **SC-008**: An asset carrying both a daily and a weekly combo and nothing else reaches the same conviction band in the degraded fallback as an asset carrying the daily combo alone — confirming the new type adds no unearned promotion (FR-015).
